	...
	#tag Event
		Sub Pressed()
		  ...
		  Catch e As DatabaseException
		    MessageBox( "Error connecting to DataBase: " + e.Message)
		  End Try
		  ...
		  mysql = "SELECT cpe23uri, cve, base_score_3, base_score,published_date FROM cvss_vs_cpes WHERE cpe23uri LIKE '%"+ cpe + "%' AND (base_score_3 >= " + score + "OR base_score >= " + score + ")"
		  Try
